				...
				require.Equal(t, map[string]interface{}{
					...
					"items": []interface{}{
						map[string]interface{}{
							...
							"bitrateReceived": out1.(map[string]interface{})["items"].([]interface{})[0].(map[string]interface{})["bitrateReceived"],
							"bitrateSent":     out1.(map[string]interface{})["items"].([]interface{})[0].(map[string]interface{})["bitrateSent"],
